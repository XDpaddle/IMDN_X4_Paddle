...
class IMDN_AS(nn.Layer):
    ...
    def forward(self, input):
        ...
        out_B = self.c(paddle.concat([out_B1, out_B2, out_B3, out_B4, out_B5, out_B6], axis=1))
